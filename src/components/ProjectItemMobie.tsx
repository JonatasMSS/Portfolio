...
export function ProjectItemMobile({ ...props }: ProjectItemMobileProps) {
    return (
        <div className="w-full items-center flex flex-col">
            ...
            <a href={props.link} className=" my-5 p-2 rounded-lg bg-white border-2 border-black active:shadow-cartoon active:scale-110 transition-all duration-300 ease-out">
                <span className="font-archivo text-base font-bold "> Repositório</span>
            </a>
        </div>
    )
}