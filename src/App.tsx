...
function App() {
  ...
  //Project Controller -> To show diferent displays based on screen size

  function ResponsiveDisplayProjects(width: number) {
    if (width >= 768) {
      return (
        <div className="w-full flex flex-col items-center px-5 mt-20">
  ...
  return (
    <div className="w-screen min-h-screen flex flex-col justify-between  overflow-hidden bg-defaultWhite">
      <div className="flex flex-col">
        <Header />
        {/* Introduction section */}
        <div className="w-full flex flex-col items-center px-4 md:px-10">
          <div
            className="w-full md:px-4 flex items-center justify-evenly bg-white  m-10 shadow-cartoon border-[3px] rounded-lg border-black">
            <div className="font-lato font-bold w-64 md:w-full">
              <span className="md:text-4xl">Olá, sou Jonatas Miguel. <span className="font-extrabold">Desenvolvedor Front-end</span></span>
            </div>
            <img src={Eu} alt="Foto de Jonatas" className="w-20 md:w-32" />
          </div>
        </div>
        ...
        {
          ResponsiveDisplayProjects(windowWidth.current)
        }
