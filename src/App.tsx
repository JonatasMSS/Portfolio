...
function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col overflow-hidden  bg-defaultWhite">
      <div className="flex flex-col ">
        ...
        <div className="w-full flex flex-col items-center px-4 md:px-10 lg:px-20">
          ...
          {/* About me section */}
          <div className="flex flex-col items-center px-4 lg:px-20 gap-2 w-full">
          ...
          <div className="flex flex-col items-center gap-10 px-4 my-10 ">
        ...
        {/* Projects Section */} 
        <span className="font-archivo-black w-full text-center md:text-2xl">Projetos</span>
        ...
        <div className="p-2 justify-items-center grid grid-flow-row grid-cols-3 my-10 ">
            {
              myProjects.map(e => e)
            }
        </div>
